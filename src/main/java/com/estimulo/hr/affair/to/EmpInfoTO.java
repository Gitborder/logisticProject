...
public class EmpInfoTO extends BaseTO {
	...
	public String[] getUserAuthorityGroupList() {
		return authorityGroupList;
	}

	public void setAuthorityGroupList(String[] authorityGroupList) {
		this.authorityGroupList = authorityGroupList;
	}

	public String[] getUserAuthorityGroupMenuList() {
		return authorityGroupMenuList;
	}

	public void setAuthorityGroupMenuList(String[] authorityGroupMenuList) {
		this.authorityGroupMenuList = authorityGroupMenuList;
	}
}