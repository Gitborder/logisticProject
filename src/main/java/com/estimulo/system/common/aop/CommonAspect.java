package com.estimulo.system.common.aop;
...
import com.estimulo.companymanaging.authoritymanager.exception.DataNotInputException;
...
//	ExceptionHandler
	 @org.springframework.web.bind.annotation.ExceptionHandler(IdNotFoundException.class)
	  public ModelAndView idNotFoundExceptionHandler(HttpServletRequest request, IdNotFoundException e) {
		  ModelAndView mv = new ModelAndView("/authoritymanager/loginform");
...
//	TransactionAspect
	 ...
	 public class TransactionAspect {
	 	...
	 	private static final String AOP_TRANSACTION_EXPRESSION = "execution(* com..serviceFacade.*.*(..) ) "; 
