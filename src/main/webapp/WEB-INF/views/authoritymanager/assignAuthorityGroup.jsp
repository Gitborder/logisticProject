...
<script>
   ...
   let authorityGroupColumn = [
       {headerName: "권한그룹명", field: "userAuthorityGroupName", checkboxSelection: true, headerCheckboxSelection: true, headerCheckboxSelectionFilteredOnly: true},
       {headerName: "권한그룹코드", field: "userAuthorityGroupCode", hide:true},
