...
<%@ page import="com.estimulo.system.base.to.BoardTO" %>
<%@ page import="com.estimulo.system.base.to.ListForm"%> 
...
<script type="text/javascript">
		...
		$.ajax({
			...
			success : function(data){	
				...
				for (var index in data.boardlist){
					...
					html += "<td class='content'>"+"<a href=${pageContext.request.contextPath}/board/detailBoard.html?board_seq="+data.boardlist[index].board_seq+">"+str+data.boardlist[index].title+"</a>"+"</td>";				
	...
	function makePage(){
		var html="";
		if(board.previous){
			html += "<a href=${pageContext.request.contextPath}/board/board.html?pn="+(board.pagenum-1)+">&lt &lt </a>&nbsp&nbsp"
		}
		for(var num=board.startpage; num<(board.endpage)+1 ; num++){
			html += "<a href=${pageContext.request.contextPath}/board/board.html?pn="+num+">"+num+"</a>&nbsp&nbsp";
		}
		if(board.next){
			html += "<a href=${pageContext.request.contextPath}/board/board.html?pn="+(board.pagenum+1)+">&gt&gt</a>"
		}
		$("#page").empty();
		$("#page").append(html);
	}
...
<body>
	...
	<div class="container">
		<div class="card1">
			<div class="card-body">
				<h3 class="display-10 text-dark font-weight-bold">게시판목록[${sessionScope.empName}]</h3>
				...
				<div class="col text-right">			
					<form action="${pageContext.request.contextPath}/board/registForm.html">
